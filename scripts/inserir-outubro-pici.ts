// Script para inserir movimentações de Outubro/2025 para a congregação Pici
// Execute: npx tsx scripts/inserir-outubro-pici.ts
...
async function inserirOutubroPici() {
  try {
    console.log('🌱 Inserindo movimentações de Outubro/2025 para Pici...\n');
    ...
    // Verificar se já existem movimentações de Outubro/2025 para Pici
    ...
    if (movimentacoesExistentes && movimentacoesExistentes.length > 0) {
      console.log(`⚠️  ATENÇÃO: Já existem ${movimentacoesExistentes.length} movimentações de Outubro/2025 para Pici!`);
      console.log('   Deseja continuar mesmo assim? As novas movimentações serão adicionadas.\n');
    }

    // Dados das movimentações de Outubro/2025 conforme a imagem
    const movimentacoesData = [
      {
        dia: 1,
        mes: 10,
        ano: 2025,
        descricao: 'Rec. Culto da vitoria- Oferta de 5,00 reais',
      ...
      },
      {
        ...
        mes: 10,
        ano: 2025,
        descricao: 'Rec. Culto da doutrina- Dizimo Levi - 100 reais',
        tipo: 'entrada' as const,
      ...
      },
      {
        ...
        mes: 10,
        ano: 2025,
        descricao: 'Rec. Culto da doutrina- Dizimo Samuel- 100 reais',
        tipo: 'entrada' as const,
        categoriaEntrada: 'dizimo' as const,
        valor: 100.00,
        congregacaoId: pici.id,
      ...
      },
      {
        ...
        mes: 10,
        ano: 2025,
        descricao: 'Rec. Culto de adoração- Ofertas 9,00 reais',
        tipo: 'entrada' as const,
        categoriaEntrada: 'ofertas' as const,
        valor: 9.00,
        congregacaoId: pici.id,
      ...
      },
      {
        ...
        mes: 10,
        ano: 2025,
        descricao: 'Rec. Culto da vitoria- Oferta de 1 reais',
        tipo: 'entrada' as const,
        categoriaEntrada: 'ofertas' as const,
        valor: 1.00,
        congregacaoId: pici.id,
      ...
      },
      {
        ...
        mes: 10,
        ano: 2025,
        descricao: 'Rec. Culto de Doutrina - Dizimo Levi 60 Reais',
        tipo: 'entrada' as const,
        categoriaEntrada: 'dizimo' as const,
        valor: 60.00,
        congregacaoId: pici.id,
      ...
      },
      {
        ...
        mes: 10,
        ano: 2025,
        descricao: 'Rec. Culto de Doutrina - Dizimo Iracema 60 Reais',
        tipo: 'entrada' as const,
        categoriaEntrada: 'dizimo' as const,
        valor: 60.00,
        congregacaoId: pici.id,
      ...
      },
      {
        ...
        mes: 10,
        ano: 2025,
        descricao: 'Rec. Culto de adoração- Ofertas 12,00 reais',
        tipo: 'entrada' as const,
        categoriaEntrada: 'ofertas' as const,
        valor: 12.00,
        congregacaoId: pici.id,
      ...
      },
      {
        ...
        mes: 10,
        ano: 2025,
        descricao: 'Rec. Culto da vitoria- Oferta de 25,00 reais',
        tipo: 'entrada' as const,
        categoriaEntrada: 'ofertas' as const,
        valor: 25.00,
        congregacaoId: pici.id,
      ...
      },
      {
        ...
        mes: 10,
        ano: 2025,
        descricao: 'Rec. Culto da vitoria- Oferta de 12,00 reais',
        tipo: 'entrada' as const,
        categoriaEntrada: 'ofertas' as const,
        valor: 12.00,
        congregacaoId: pici.id,
      ...
      },
      {
        ...
        mes: 10,
        ano: 2025,
        descricao: 'Rec. Culto de adoração- Ofertas 14,00 reais',
        tipo: 'entrada' as const,
        categoriaEntrada: 'ofertas' as const,
        valor: 14.00,
        congregacaoId: pici.id,
      ...
      },
      {
        ...
        mes: 10,
        ano: 2025,
        descricao: 'Rec. Culto de adoração- dizimo aurineide 70,00',
        tipo: 'entrada' as const,
        categoriaEntrada: 'dizimo' as const,
        valor: 70.00,
        congregacaoId: pici.id,
      ...
      },
      {
        ...
        mes: 10,
        ano: 2025,
        descricao: 'Rec. Culto de adoração- oferta especial Cristina',
        tipo: 'entrada' as const,
        categoriaEntrada: 'ofertas' as const,
        valor: 50.00,
        congregacaoId: pici.id,
      ...
      },
      {
        ...
        mes: 10,
        ano: 2025,
        descricao: 'Rec. Culto da vitoria- Dizimo da Eleneuda',
        tipo: 'entrada' as const,
        categoriaEntrada: 'dizimo' as const,
        valor: 150.00,
        congregacaoId: pici.id,
    ...
    for (const mov of movimentacoesData) {
      try {
        ...
        sucesso++;
        console.log(`  ✓ ${mov.dia}/10 - ${mov.descricao.substring(0, 50)}...`);
      } catch (error: any) {
        erros++;
